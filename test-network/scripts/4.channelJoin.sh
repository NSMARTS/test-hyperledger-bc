...
# contractchannel 생성 
echo 채널 블록 생성
../../bin/configtxgen -profile TwoOrgNetworkRaft -configPath ${PWD}/../configtx -outputBlock contractchannel.block -channelID contractchannel
sleep 3
#----------------------------------------------------------------------------------------------
...
../../bin/osnadmin channel join --channelID contractchannel --config-block contractchannel.block -o localhost:7053 --ca-file $ORDERER_CA --client-cert ${PWD}/../organizations/peerOrganizations/naver.com/admin/tls-msp/signcerts/cert.pem --client-key ${PWD}/../organizations/peerOrganizations/naver.com/admin/tls-msp/keystore/key.pem
sleep 3

echo 오더러2 채널 참가

export ORDERER_CA=${PWD}/../organizations/peerOrganizations/naver.com/orderers/orderer2.naver.com/tls-msp/tlscacerts/tls-0-0-0-0-5054.pem
../../bin/osnadmin channel join --channelID contractchannel --config-block contractchannel.block -o localhost:7055 --ca-file $ORDERER_CA --client-cert ${PWD}/../organizations/peerOrganizations/naver.com/admin/tls-msp/signcerts/cert.pem --client-key ${PWD}/../organizations/peerOrganizations/naver.com/admin/tls-msp/keystore/key.pem
sleep 3

#----------------------------------------------------------------------------------------------

#----------------------------------------------------------------------------------------------
#contract 채널엔 딜리버리가 없다.
...
../../bin/peer channel join -b contractchannel.block
